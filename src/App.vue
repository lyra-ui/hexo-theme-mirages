...
export default defineComponent({
  ...
  setup() {
    ...
    const resizeHandler = () => {
      ...
      if (isDoubleLineFooter.value !== footerState) commonStore.changeFooterState(footerState)
    }
    ...
    const comptuedAnnouncement = () => {
      const lastAnnouncement = getCookie('announcement') ? decodeURIComponent(getCookie('announcement')!) : null
      ...
      if (lastAnnouncement) {
        ...
        showAnnouncement.value = currentAnnouncement !== '' && currentAnnouncement !== null
      }
    }
